...
| Group | Weeks | What it covers |
|---|---|---|
| Design Think / Critique | Wk1 | Framing, critique of process itself |
| Research & Fieldwork | Wk2–3 | Site visits, interviews, coding |
| Synthesis | Wk3, 5–6 | Visualizations, HMWs, ideation |
| Prototyping & Iteration | Wk4, 7, 9–11, 13 | Sacrificial + fidelity-increasing prototypes |
| Feedback & Testing | Wk12 | Return-to-site validation |
| Final Communication | Wk14–16 | Pitch deck, presentation, self-reflection |
...
## Archiving for Assessment

No ePortfolio needed. Canvas already stores every submission permanently on the instructor side. At any assessment checkpoint (mid-semester, end of term, accreditation cycle):
